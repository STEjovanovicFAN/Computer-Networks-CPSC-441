...
public class Tester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Last-Modified for " + url[0] + " is: " + cache.getLastModified(url[0]));
			System.out.println("Last-Modified for " + url[1] + " is: " + cache.getLastModified(url[0]));
			System.out.println("Last-Modified for " + url[2] + " is: " + cache.getLastModified(url[0]));
			System.out.println("Last-Modified for " + url[3] + " is: " + cache.getLastModified(url[0]));
		}
		catch (IOException e) {
